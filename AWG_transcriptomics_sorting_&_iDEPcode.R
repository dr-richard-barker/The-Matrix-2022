...
URLs<-c("https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-120_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-147_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-193_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-205_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-208_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-213_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-217_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-251_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-282_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-296_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-313_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-314_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-321_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-346_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-37_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-38_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-427_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-428_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-434_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-450_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-498_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-502_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-508_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-510_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-519_rna_seq_normalized_Counts.csv",
    "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/OSD-565_rna_seq_normalized_Counts.csv",

GeneLab differential epxression example
#Define URLs and destination files for downloading RNA-seq/microarray DEG datasets 
URLs<-c("https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-401_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-379_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-214_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-243_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-244_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-245_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-246_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-248_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-253_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-254_rna_seq_Unnormalized_Counts.csv",
        "https://genelab-data.ndc.nasa.gov/genelab/static/media/dataset/GLDS-289_rna_seq_Unnormalized_Counts.csv"
)
destFiles<-c("GLDS-401_rna_seq_Unnormalized_Counts.csv",
             "GLDS-379_rna_seq_Unnormalized_Counts.csv",
             "GLDS-214_rna_seq_Unnormalized_Counts.csv",
             "GLDS-243_rna_seq_Unnormalized_Counts.csv",
             "GLDS-244_rna_seq_Unnormalized_Counts.csv",
             "GLDS-245_rna_seq_Unnormalized_Counts.csv",
             "GLDS-246_rna_seq_Unnormalized_Counts.csv",
             "GLDS-248_rna_seq_Unnormalized_Counts.csv",
             "GLDS-253_rna_seq_Unnormalized_Counts.csv",
             "GLDS-254_rna_seq_Unnormalized_Counts.csv",
             "GLDS-289_rna_seq_Unnormalized_Counts.csv")
...
MouseMetaMatrix <- read_csv("destFiles")
