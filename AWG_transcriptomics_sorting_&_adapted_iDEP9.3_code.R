# R code for used for the GeneLab Plant AWG Matrix Analysis

### AWG data metadata tidy up....

### Note: The GeneLab API was not used to access the processed data as it was not completed at the start of this project

library(tidyverse)
##Import microarray
library(readr)> 
MetaAndArrayNormalizedIntens6232020 <- read_csv("Google Drive/MetaAndArrayNormalizedIntens6232020.csv")
## /Users/Google Drive/Plant_AWG_microarray_NormalizedCounts.csv

##Import RNAseq
library(readr)>
MetaAndRNANormalizedCounts6232020 <- read_csv("Google Drive/MetaAndRNANormalizedCounts6232020.csv")
## /Users/Google Drive/Plant_AWG_RNAseq_NormalizedCounts.csv
...
## /Users/Google Drive/Plant_AWG_merged_RNAseqMicroArray_matrix.csv
## /Users/Google Drive/Plant_AWG_MetaData_Merged_v1.csv


# This section is adapted from Steven Xijin Ge, South Dakota State University, some was generated by iDEP 0.92  hosted at http://ge-lab.org/idep/ on Wed Jul  1 18:30:15 2020 
